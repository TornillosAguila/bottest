...
(function () {
  ...
  function buildResumenEmpresa() {
    ...
    gV.innerHTML = `
      ...
      <div class="kpi-card red"><div class="kpi-label">💰 Ventas Totales</div><div class="kpi-value" data-anim-val="${totV}" data-anim-fmt="money">${fmtK(totV)}</div><div class="kpi-sub">Suma anual real</div></div>`;
    ...
    gO.innerHTML = `
      ...
      <div class="kpi-card red"><div class="kpi-label">⏱️ Días Prom. Reparación</div><div class="kpi-value" data-anim-val="${avgDias}" data-anim-fmt="dplain">${avgDias.toFixed(1)}</div><div class="kpi-sub">Promedio anual</div></div>`;
    ...
    gA.innerHTML = `
      ...
      <div class="kpi-card green"><div class="kpi-label">📈 % Recuperación</div><div class="kpi-value" data-anim-val="${avgRec*100}" data-anim-fmt="pct">${(avgRec*100).toFixed(1)}%</div><div class="kpi-sub">Promedio · meta &lt;33%</div></div>
      ...
      <div class="kpi-card blue"><div class="kpi-label">🔄 Ingreso esperado x cartera</div><div class="kpi-value" data-anim-val="${ingresoEsperadoCartera}" data-anim-fmt="money">${fmtK(ingresoEsperadoCartera)}</div><div class="kpi-sub">% Recup. × Cartera vigente</div></div>`;
  }
